...
test("legacy retired-provider purge marker 137 moves to 140 and frees release migration 137", async () => {
  ...
  try {
    ...
    withMockedMigrationFs(
      {
        ...
        "140_retired_provider_purge.sql":
    ...
    assert.deepEqual(
      ...
      [
        ...
        { version: "140", name: "retired_provider_purge" },
      ]
    );
    assert.ok(
      db
